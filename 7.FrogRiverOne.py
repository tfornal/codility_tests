...
bank of the river (position 0) and wants to get to the opposite bank (position X+1). Leaves fall from 
...
the current in the river is negligibly small, i.e. the leaves do not change their positions once they fall
 in the river.
...
that, given a non-empty array A consisting of N integers and integer X, returns the earliest time when the 
